...
--  EVENT_MANAGER:RegisterForEvent(EHA.name, EVENT_CLIENT_INTERACT_RESULT, EHAInteract.ClientInteractResult)
--  EVENT_MANAGER:RegisterForEvent(EHA.name, EVENT_COLLECTIBLE_USE_RESULT, function(event, ...) d('EVENT_COLLECTIBLE_USE_RESULT', ...) end)
--  EVENT_MANAGER:RegisterForEvent("EHA.name", EVENT_PLAYER_COMBAT_STATE, EHAInteract.OnCombatStateChange)
--  EVENT_MANAGER:RegisterForEvent("EHA.name", EVENT_COMBAT_EVENT, EHAInteract.HandleCombatEvent)
--  EVENT_MANAGER:AddFilterForEvent("EHA.name", EVENT_COMBAT_EVENT, REGISTER_FILTER_TARGET_COMBAT_UNIT_TYPE, COMBAT_UNIT_TYPE_TARGET_DUMMY)

    EHA.d("Eysile's HousingTools is now active")
  else 
    EVENT_MANAGER:UnregisterForUpdate(EHA.name .. 'Animations')
    EVENT_MANAGER:UnregisterForUpdate(EHA.name .. 'Interact')
...
--  EVENT_MANAGER:UnregisterForEvent(EHA.name, EVENT_PLAYER_COMBAT_STATE)
--  EVENT_MANAGER:UnregisterForEvent(EHA.name, EVENT_COMBAT_EVENT)
